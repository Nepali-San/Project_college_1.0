                        ...
                        <div class="col-md-12">                         
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" value="{{ $user->first_name }}" name = 'first_name' placeholder="Enter your first name">
                                </div>          

                                <div class="form-group col-md-6">
                                    <label>Last Name</label>
                                    <input class="form-control"  value="{{ $user->last_name }}" name = 'last_name' placeholder="Enter your last name">
                                </div>
                            </div>  
                            <div class="row">   
                                <div class="form-group col-md-6">                                   
                                    <label>Username</label>
                                    <input class="form-control" value="{{ $user->username }}"  name = 'username' placeholder="Enter your Username">
                                </div>

                                <div class="form-group col-md-6">                                   
                                    <label>E-mail</label>
                                    <input class="form-control" name = 'email' value="{{ $user->email }}" placeholder="Enter your Email">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
